...
function init() {
  ...
  db.exec(`CREATE INDEX IF NOT EXISTS idx_entity_records_entity ON entity_records (entity_name)`)
  db.exec(`CREATE INDEX IF NOT EXISTS idx_entity_records_tenant ON entity_records (tenant_id)`)
  ...
  db.exec(`CREATE UNIQUE INDEX IF NOT EXISTS idx_appsettings_tenant_key ON appsettings (tenant_id, setting_key)`)
